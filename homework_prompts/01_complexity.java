...
class Main {
   ...
   * 
   * 1. 5 + N Answer: N 2. N + N^2 Answer: N^2 3. 15N + 13N Answer: N 4. 10000
   * Answer: 1 5. log(N) + 1 Answer: log(N) 6. log(N) * 3 + 14N + 3 Answer: N 7.
   * Nlog(N) + 3N^2 Answer: N^2 8. N^3 + log(N^4) Answer: 2^N 9. N! + 180000N^2
   * Answer: N! 10. 15002^N Answer: 1^N
   */
   ...
   * Counting Sort
   * 
   * Given an array and a range (min and max), use counting sort to sort the input
   * array.
   * 
   * Parameters Input: arr {Array of Integers} Input: min {Integer} Input: max
   * {Integer} Output: {Array of Integers}
   * 
   * Examples [5, 3, 1, 8, 9] --> [1, 3, 5, 8, 9] [8, 1, 3, 4, 6, 9] --> [1, 3, 4,
   * 6, 8, 9] [4, 0, 1, 5, 6] --> [0, 1, 4, 5, 6]
   * 
   * Time Complexity: M + N Auxiliary Space Complexity: M + N
   * 
   */
   ...
   * Binary Search
   * 
   * Given a sorted array and a target value, use binary search to return the
   * index of the target in the input array. Return -1 if no such target is found.
   * 
   * Parameters Input: arr {Array of Integers} Input: val {Integer} Output:
   * {Integer}
   * 
   * Examples [1, 3, 4, 5, 8, 9], 5 --> 3 [5, 7, 10, 12, 14], 7 --> 1 [2, 4, 8, 9,
   * 15], 3 --> -1
   * 
   * Time Complexity: log(N) Auxiliary Space Complexity: 1
   * 
   */
   ...
   * 
   * Parameters Input: n {Integer} Output: {Integer}
   * 
   * Examples 5 --> 120 (5 * 4 * 3 * 2 * 1) 1 --> 1 (1) 9 --> 362880 (9 * 8 * 7 *
   * 6 * 5 * 4 * 3 * 2 * 1)
   * 
   * Time Complexity: N Auxiliary Space Complexity: N
   * 
   ...
   * First Times Last
   *
   * Time Complexity: 1 Auxiliary Space Complexity: 1
   */
   ...
   *
   * Time Complexity: N^2 Auxiliary Space Complexity: 1
   */
  ...
  /**
   * Problem 5 Time Complexity: M * N Auxiliary Space Complexity: M * N
   */
   ...
   *
   * Input: arr {Array} Output: {ArrayList}
   *
